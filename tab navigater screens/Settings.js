  ...
  async function navigate() {
    if (navigatePage === "sendmail" || navigatePage === "help&support") {
      MailComposer.composeAsync({
        ...
        subject:
          navigatePage === "sendmail" ? "Feedback 📝" : "Help & Support 🙌", // Subject of the email
        body:
          navigatePage === "sendmail"
            ? "Please enter your feedback here..."
            : "We're here to assist you. How may we help?", // Body of the email
      });
    } else if (navigatePage === "Privacy") {
      const url =
        "https://sites.google.com/view/ongoal-task-scheduler-app/home";
