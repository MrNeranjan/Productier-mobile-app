...
export default function LoginPage() {
  ...
  function generateOTP() {
    ...
    // Generate time
    setGenerateTime(new Date().toISOString());
  }
  // Requesting to the server to send the OTP to user email
  async function sendOTP() {
    ...
    axios
      .post("http://192.168.8.178:3000/forgotPassword", {
  ...
  function forgetPasswordHandler() {
    sendOTP();
    navigation.push("ForgetPassPage", { OTP: OTPCode, gTime: generateTime });
  }
